...
namespace teste_.Models
{
    public class BancoDB : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) {
            //optionsBuilder.UseSqlServer(connectionString: @"Data Source = dbdev9.curitiba.pr.gov.br\dev2014; Initial Catalog = provacandidato; User ID = provacandidato; Password = desenvolvimento");
